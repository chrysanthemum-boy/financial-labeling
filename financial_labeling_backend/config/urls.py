...
schema_view = get_schema_view(
    openapi.Info(
        title="financial-labeling API",
        default_version="v1",
        description="financial-labeling API description",
...
urlpatterns += [
    ...
    path("", include("data_export.urls")),
    path("", include("projects.urls")),
    path("projects/<int:project_id>/metrics/", include("metrics.urls")),
    path("projects/<int:project_id>/", include("auto_labeling.urls")),
    path("projects/<int:project_id>/", include("labels.urls")),
    path("projects/<int:project_id>/", include("label_types.urls")),

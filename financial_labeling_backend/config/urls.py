...
urlpatterns += [
    ...
    path("fann_v1/", include("api.urls")),
    path("fann_v1/", include("roles.urls")),
    path("fann_v1/", include("users.urls")),
    path("fann_v1/", include("data_import.urls")),
    path("fann_v1/", include("data_export.urls")),
